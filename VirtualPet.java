...
public class VirtualPet extends VirtualPetFace
{
    VirtualPetFace face;
    double money = 100;
    ...
    private double yearsRemaining = 20;
    ...
    public VirtualPet()
    {
        ...
        resetGame();
        face.repaint(); //supposed to clear the face.setMessage box
    ...
    public void relax()
    {
        ...
        stress -= 4; // I really hope this one is common sense. But the more you relax with some honnies, the less stress you carry
    ...
    private void checkIfDone() //this one just keeps the user fair and makes sure a dead pet isn't walking around
    {
        if(yearsRemaining < 1) //just to catch any bugs. I think this is fair and really allows for me to be efficient
        {
            ...
            {
                face.setImage("cat_rich"); //rich cat because it is rich
                ...
                timer.setInitialDelay(3000); //keeps the image on there for three seconds before reseting the game
            ...
            else if  (money < 200 && money >100) // for those who might not have done as well
            {
                ...
                face.setImage("cat_notBad"); // again, not too bad
                resetGame(); //resets the game

            }
            else
            {
                face.setImage("cat_sad"); //presumably, the user lost money here. Bad gameplay
                ...
                timer.setInitialDelay(3000); //delay again
                resetGame(); //resets the game
        ...
        else if (stress > 20 || tiredness > 20) //this will kill you if your pet is too stressed or tired. Again, the emotion ceiling is 20!
        {
            ...
            timer.setInitialDelay(3000); //another delay before reseting
            resetGame(); //resets the game
        }
    }
